...
## toml-pretty-sort 0.0.3

### Fixed

- new version release with no ".dev0" suffix

## toml-pretty-sort 0.0.2

### Changed

- update minimum `tomlkit` to `0.12.3`
- refactor CLI to update parser defaults in main cli() function (in order to help fix docs build)

### Fixed

- fix `pretty-toml-sort --version`

## toml-pretty-sort 0.0.1

### Added

- add inner spacing to inline objects (non-empty), as proposed in: https://github.com/pappasam/toml-sort/pull/68

---

# from original toml-sort
